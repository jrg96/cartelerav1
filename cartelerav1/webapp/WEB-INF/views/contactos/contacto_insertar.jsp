...
<html lang="en">
   ...
   <body>
      ...
      <div class="container theme-showcase" role="main">
         ...
         <form:form class="form-horizontal" action="${urlRoot}contactos/save" method="POST" modelAttribute="contacto">
            <div class="form-group">
               <label for="nombre" class="col-sm-2 control-label">Nombre</label>
               <div class="col-sm-10">
                  <form:input type="text" class="form-control" id="nombre" path="nombre" required="required" placeholder="Nombre" />
               </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
               ...
               <div class="col-sm-10">
                  <form:select id="genero"  path="generos" multiple="multiple" class="form-control" items="${lista_generos}" />
               </div>
            </div>
